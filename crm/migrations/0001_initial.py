    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CallType', models.CharField(choices=[('PhoneCall', 'PhoneCall'), ('Email', 'Email'), ('SMS', 'SMS'), ('FaceToFace', 'FaceToFace')], max_length=20)),
